...
for cnn_index, cnn_type in enumerate(siamese_auxiliary_loss):
    ...
    print('Start training over {} folds for CNN type siamese = {}, auxiliary_loss = {}.\n'.format(nb_folds, siam, aux))
    ...
    print('Average loss over {} folds: mean = {:.1f}, std = {:.2f}'.format(nb_folds, loss_mean[-1], loss_std[-1]))
    ...
    plt.figure('Average train and test final error over {} folds, siamese = {}, auxiliary_loss = {}'.format(nb_folds, siam, aux))
    ...
    if aux:
        plt.figure('Average train and test auxiliary error over {} folds, siamese = {}, auxiliary_loss = {}'.format(nb_folds, siam, aux))
    ...
    plt.figure('Test error for different models')
