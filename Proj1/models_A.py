...
class A_auxiliary_loss(nn.Module):
    """
    ...
    def __init__(self):
        super(A_auxiliary_loss, self).__init__()
        """  Create the correct number of convolutional layers and initialize their weights  """
...
class A_siamese_and_auxiliary_loss(nn.Module):
    """
    ...
    def __init__(self):
        super(A_siamese_and_auxiliary_loss, self).__init__()
        """  Create the correct number of convolutional layers and initialize their weights  """
